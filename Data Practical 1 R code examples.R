...
plot(EXCH_Al ~ PH, xlab="Soil pH", 
     ...
     pch=c(1,16)[Rel.To.Brook], 
     col=c("blue","darkred")[Rel.To.Brook])
legend("topleft", legend=levels(Rel.To.Brook), pch=c(1,16), 
...
# multiple graphs
par(mfrow=c(1,2))
stripchart(hubbard$OM.pct, data=hubbard, main="Strip Chart")
plotMeans(OM.pct, Transect, data=hubbard, error.bars = "conf.int")
